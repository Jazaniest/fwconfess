/**
 * Ban repository — management ban user.
...
/**
 * Ban user (admin quick-action): set is_active = 0
 * Dipakai oleh admin panel untuk suspend cepat.
 */
...
/**
 * Unban user (admin quick-action): set is_active = 1
 */
