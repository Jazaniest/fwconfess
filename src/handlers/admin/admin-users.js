/**
 * Admin users handler — business logic untuk kelola user.
 */
...
export async function handleAdminListUsers(ctx, offset) {
  const limit = 10;
...
export async function handleAdminUserDetail(ctx, targetId, backSource, backOffset) {
...
export async function handleAdminBanConfirm(ctx, targetId, backSource, backOffset) {
  await ctx.editMessageText(
...
export async function handleAdminDoBan(ctx, targetId, backSource, backOffset) {
...
export async function handleAdminUnbanConfirm(ctx, targetId, backSource, backOffset) {
  await ctx.editMessageText(
...
export async function handleAdminDoUnban(ctx, targetId, backSource, backOffset) {
...
export async function handleAdminSearchUser(ctx, adminInputState) {
...
export async function handleAdminSearchResults(ctx, adminInputState, offset) {
  ...
  await showSearchResults(ctx, adminInputState, state.searchQuery, offset);
}

export async function showSearchResults(ctx, adminInputState, query, offset = 0) {
  const limit = 10;
  ...
  adminInputState.set(ctx.from.id, { searchQuery: query });
...
export async function handleAdminBannedUsers(ctx, offset) {
  const limit = 10;
...
export async function handleAdminNewUsers(ctx) {
...
export async function handleAdminUserStats(ctx) {
